...
export default function Tutorial() {
  ...
  return (
    <section id="tutorial" className="relative max-w-5xl mx-auto pt-20 px-5 text-center">
      <h2 ref={headingRef} className="text-3xl font-bold mb-4 reveal">{t('tutorial_heading')}</h2>
      <p className="text-lg mb-8" style={{ color: 'var(--color-offwhite-2)' }}>
        {t('tutorial_subheading')}
      </p>

      <div ref={videoRef} className="reveal" style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
        <iframe
